...
import com.madlab.familyvideo.ext.alexamino.intent.util.DateUtil;
...
public class UtteranceHandlerContext {
    ...
    private class UtteranceMethodParameterContext {
        ...
        public void init(Parameter[] parameters) {
            Parameter parameter;
            com.madlab.familyvideo.ext.alexamino.annotation.Slot slot;
            for (int pIdx = 0; pIdx < parameters.length; pIdx++) {
                parameter = parameters[pIdx];
                if (parameter.isAnnotationPresent(com.madlab.familyvideo.ext.alexamino.annotation.Slot.class)) {
                    slot = parameter.getAnnotation(com.madlab.familyvideo.ext.alexamino.annotation.Slot.class);
    ...
    protected class SlotContext {
        ...
        private final com.madlab.familyvideo.ext.alexamino.annotation.Slot.DateFilter dateFilter;

        public SlotContext(int ordinal, Class type, String name, String pattern,
                           com.madlab.familyvideo.ext.alexamino.annotation.Slot.DateFilter dateFilter) {
        ...
        public com.madlab.familyvideo.ext.alexamino.annotation.Slot.DateFilter getDateFilter() {
            return dateFilter;
        }
    }
}
